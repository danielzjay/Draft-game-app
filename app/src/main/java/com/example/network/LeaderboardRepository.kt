 ...
 *
 * Bots are NEVER written here. Rankings should only ever reflect real players — bot matches
 * happen offline (or as an online fallback when no real opponent is available) and never touch
 * this collection. If you want to know how a bot is performing, that's tracked separately in
 * BotMemoryRepository, not mixed into real rankings.
 *
...
object LeaderboardRepository {
    ...
    /** Live top-N entries, ordered by MMR descending. Real players only. */
